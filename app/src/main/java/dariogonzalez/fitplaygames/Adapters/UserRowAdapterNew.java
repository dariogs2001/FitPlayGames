...
public class UserRowAdapterNew extends ArrayAdapter<UserListItem> {
    Context mContext;
    private List<UserListItem> mFriendList = new ArrayList<>();
    private boolean isInvite;
    private boolean isLeaderBoard = false;

    public UserRowAdapterNew(Context context, int resource, List<UserListItem> mFriendList, boolean isInvite) {
    ...
    public UserRowAdapterNew(Context context, int resource, List<UserListItem> mFriendList, boolean isInvite, boolean isLeaderBoard) {
        super(context, resource, mFriendList);
        mContext = context;
        this.mFriendList = mFriendList;
        this.isInvite = isInvite;
