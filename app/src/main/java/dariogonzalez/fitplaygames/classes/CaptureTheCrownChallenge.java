        ...
        nextPlayerQuery.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> list, ParseException e) {
                if (e == null && !list.isEmpty()) {
                    ...
                    ParentChallenge.sendPushNotification("Congratulations! You have captured the crown in " + challenge.get(ParseConstants.CHALLENGE_CHALLENGE_NAME) + "!", nextPlayerUser);
                }
            }
        });
    }
